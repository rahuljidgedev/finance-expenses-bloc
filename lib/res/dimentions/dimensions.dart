abstract class Dimensions{
  ...
  double get homeCardMargin;

  double get homeFallbackIconSize;

  double get homeSubtitleText;

  double get homeSubtitleTopSpacing;

  double get homeBudgetBarHeight;

  double get homeAnimationDuration;
}